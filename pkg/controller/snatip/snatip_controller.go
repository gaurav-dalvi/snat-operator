...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &noironetworksv1.SnatIP{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// TODO(user): Modify this to be the types you create that are owned by the primary resource
	// Watch for changes to secondary resource Pods and requeue the owner SnatIP
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &noironetworksv1.SnatIP{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileSnatIP) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	// Set SnatIP instance as the owner and controller
...
func newPodForCR(cr *noironetworksv1.SnatIP) *corev1.Pod {
