...
func (in *SnatAllocationStatus) DeepCopyInto(out *SnatAllocationStatus) {
	*out = *in
	if in.SnatAllocationItems != nil {
		in, out := &in.SnatAllocationItems, &out.SnatAllocationItems
		*out = make([]SnatItems, len(*in))
		copy(*out, *in)
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SnatItems) DeepCopyInto(out *SnatItems) {
	*out = *in
	out.SnatPortRange = in.SnatPortRange
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SnatItems.
func (in *SnatItems) DeepCopy() *SnatItems {
	if in == nil {
		return nil
	}
	out := new(SnatItems)
